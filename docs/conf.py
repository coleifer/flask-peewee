...
# built documents.
#
# The version info is derived from the installed package so the docs never
# advertise a stale release number.
try:
    from flask_peewee import __version__ as release
except Exception:
    release = '3.1.0'
